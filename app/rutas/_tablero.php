...
use Leaf\Router;
use SARCO\Mediadores\AseguradorDeQueElUsuarioEstaAutenticado;

Router::group(
  '/',
  ['middleware' => function (): void {
    contenedor()->get(AseguradorDeQueElUsuarioEstaAutenticado::class);
  }, function (): void {
    ...
    // Router::get('/representantes/{cedula}/editar', function (string $cedula): void {
    ...
    // Router::post('/representantes/{cedula}/editar', function (string $cedula): void {
    //   $info = Request::body();
